...
export default class Popup extends React.PureComponent {
  ...
  renderContent = (Astyles = {}) => {
    const { arrow, arrowStyle } = this.props;
    const { modal } = this.state;
    return (
      <div {...this.addWarperAction()} style={Astyles} key="C">
        {arrow &&
          !modal && (
            <div
        ...
        <Spring from={{ opacity: 0 }} to={{ opacity: 1 }}>
          {Astyles => (
            <div
              ...
              style={Object.assign({}, ovStyle, overlayStyle, Astyles)}
            ...
            >
              ...
              >
                {Astyles => {
                  return modal && this.renderContent(Astyles);
                }}
              </Spring>
            </div>
          )}
